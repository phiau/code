...
class helloworld : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:lm.helloworld) */ {
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_lm_2ehelloworld_2eproto_impl();
  friend void  protobuf_AddDesc_lm_2ehelloworld_2eproto_impl();
  friend const ::google::protobuf::uint32* protobuf_Offsets_lm_2ehelloworld_2eproto();
